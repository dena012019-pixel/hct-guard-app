...
# Updated VAM Data with Custom Reference Names and Specifications
...
with col2:
    ...
    # Dynamic Matching Logic display
...
# Vendor Live Sync Section & Features Box
st.markdown("---")
...
# Added Features Section below Vendor Check as requested
